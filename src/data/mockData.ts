...
export const TRANSLATIONS = {
  ar: {
    ...
    problemType: 'نوع المشكلة الرئيسي',
    problemSelect: 'اختر نوع المشكلة المصادفة',
    ...
    chartProblemTypes: 'نسب توزيع أنواع المشاكل الشائعة',
  ...
  en: {
    ...
    problemType: 'Main Issue Type',
    problemSelect: 'Select encountered issue',
    ...
    chartProblemTypes: 'Common Issue Types Distribution',
